 ...
 * 
 * A utility class with special functions for dealing with difficult character-
 *  encoding issues.
 *
 * @author David Hazel
...
class Vci_String_Encoding {
   ...
   * Taken from the public domain.
   *
   * The author says that this function simply iteratively calls toUtf8()
   *  until no change is detected in the given string. This can be handy for
   *  fixing strings that have multiple layers of re-encodings.
   **/
